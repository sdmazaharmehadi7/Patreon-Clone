        ...
        <>
            ...
            <div className='container mx-auto py-5 px-6 '>
                ...
                <form className="max-w-2xl mx-auto" action={handleSubmit}>
                    ...
                    {/* input for email */}
                    <div className="my-2">
                        <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email (Cannot be modified)</label>
                        ...
                        <input
                            ...
                            type="email"
                            id="email"
                            className="block w-full p-2 text-gray-500 border border-gray-300 rounded-lg bg-gray-200 text-xs cursor-not-allowed select-none opacity-80 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400"
                        />
                        <p className="mt-1 text-xs text-gray-400">Email address is permanently linked to your account and cannot be modified.</p>
                    </div>
                    {/* input forusername */}
                    <div className='my-2'>
                    ...
                    <div className="my-2">
                        ...
                        <input value={form.profilepic ? form.profilepic : ""} onChange={handleChange} placeholder="Image URL (leave blank for default avatar)" type="text" name='profilepic' id="profilepic" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </div>

                    {/* input for cover pic  */}
                    <div className="my-2">
                        <label htmlFor="coverpic" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cover Picture URL</label>
                        <input value={form.coverpic ? form.coverpic : ""} onChange={handleChange} placeholder="Image URL (leave blank for default banner)" type="text" name='coverpic' id="coverpic" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </div>
                    {/* input razorpay id */}
                    <div className="my-2">
