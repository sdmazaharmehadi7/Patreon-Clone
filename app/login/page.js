    ...
    useEffect(() => {
        if (status === "authenticated" && session?.user) {
            if (session.user.isNewUser) {
                ...
                router.replace(`/${session.user.username || session.user.name}`)
            }
        }
    ...
    return (
        <div className='text-white py-14 container mx-auto'>
            ...
            <div className="flex flex-col gap-3 min-h-screen items-center p-10">
                ...
                <button onClick={() => signIn("github", { callbackUrl: "/login" })}
                    className="flex items-center justify-center w-72 bg-gradient-to-r from-purple-600 to-blue-600 text-white border-2 border-purple-300 rounded-xl shadow-xl shadow-purple-600/40 px-6 py-3.5 text-sm font-bold hover:from-purple-500 hover:to-blue-500 hover:scale-105 active:scale-95 transition-all cursor-pointer ring-4 ring-purple-500/30 mb-2">
                ...
                <div className="w-64 flex items-center justify-between my-2 text-xs text-gray-500">
                    <span className="h-px bg-gray-700 flex-1"></span>
                    <span className="px-2">Other providers</span>
                    <span className="h-px bg-gray-700 flex-1"></span>
                </div>
                ...
                <button
                    disabled
                    className="flex items-center justify-between w-64 bg-slate-800 text-gray-400 border border-gray-700 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium opacity-40 cursor-not-allowed pointer-events-none">
                    ...
                    <span className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Disabled</span>
                </button>
                    ...
                    <div className="flex items-center">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                            ...
                            <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <g id="Dribbble-Light-Preview" transform="translate(-102.000000, -7439.000000)" fill="#9CA3AF">
